    ...
    if (productData) {
      ...
      var productDescDiv = document.querySelector('.product_desc');
        ...
        window.selectColor = function (color) {
            // Implementoni kodin për ndryshimin e ngjyrës së produktit në bazë të selektuar
            // Këtu mund të përdorni ngjarjet e klikimit për të ndryshuar ngjyrën në modal ose në foton kryesor.
        ...
        window.addToCart = function () {
            ...
            var selectedColor = ''; 
            console.log('Added to cart - Quantity: ' + selectedQuantity + ', Color: ' + selectedColor);
        };
